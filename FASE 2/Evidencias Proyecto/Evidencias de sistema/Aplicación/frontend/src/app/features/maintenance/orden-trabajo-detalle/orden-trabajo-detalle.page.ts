...
import { ApiService, OrdenTrabajoDetalle, DetalleOtData, UsuarioResumen } from '../../../core/services/api.service';
...
@Component({
  ...
  standalone: true,
  imports: [IonicModule, CommonModule, FormsModule, AlertaPersonalizadaComponent, ModalHeaderComponent, ModalFooterComponent]
})
