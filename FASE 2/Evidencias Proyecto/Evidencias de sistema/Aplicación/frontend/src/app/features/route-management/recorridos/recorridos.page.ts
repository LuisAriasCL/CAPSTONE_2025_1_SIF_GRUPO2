...
import { ApiService, Vehiculo, Route as RutaInterface } from '../../../core/services/api.service';
...
const MAP_ICONS = {
  RETINA_URL: 'assets/marker-icon-2x.png',
...
const DEFAULT_ROUTE_NAME = "Mapa de Flota";

// Configuración del ícono por defecto
const defaultIcon = L.icon({
  iconRetinaUrl: MAP_ICONS.RETINA_URL,
  iconUrl: MAP_ICONS.URL,
  shadowUrl: MAP_ICONS.SHADOW_URL,
  iconSize: MAP_CONFIG.ICON_SIZE,
  iconAnchor: MAP_CONFIG.ICON_ANCHOR,
  popupAnchor: MAP_CONFIG.POPUP_ANCHOR,
  tooltipAnchor: MAP_CONFIG.TOOLTIP_ANCHOR,
...
export class HomePage implements OnInit, OnDestroy {
  ...
  // Estado de la aplicación (manteniendo nombres originales para compatibilidad)
  ...
  public nombreRutaMostrada: string | null = DEFAULT_ROUTE_NAME;
  ...
  private createPopupContent(vehiculo: VehiculoConDatosSimulacion): string {
    ...
    if(vehiculo.estadoVehi) html += `Estado: ${this.getEstadoLabel(vehiculo.estadoVehi)}<br>`;
